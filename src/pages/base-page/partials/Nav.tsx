            ...
            <nav>
                <ul className="font-medium">
                    <StyledSubMenuItem className="relative list-none float-left w-full md:w-auto py-2.5 md:p-0 leading-10">
                        ...
                        <ul className="p-1.5 border  relative left-0 opacity-0 transition-opacity duration-500 invisible w-full md:absolute md:w-48 hidden md:flex flex-col bg-white shadow-lg rounded-lg gap-2 py-3 ">
