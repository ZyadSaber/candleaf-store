...
(
    <div className="flex flex-col w-full md:w-96 h-80 mt-10 rounded-lg bg-white justify-center items-center gap-2 px-2 md:px-10 hover:shadow-lg transition-shadow">
